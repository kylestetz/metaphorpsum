...
exports.generateSentences = function(req, res){
  ...
  for(var i = 0; i < numberOfSentences; i++) {
    ...
    if(cap){
      sentences += capitalizeFirstLetter(wordWithAOrAn()) + " is like " + wordWithAOrAn() + " in " + wordWithAOrAn() + ".";
    } else {
      sentences += wordWithAOrAn() + " is like " + wordWithAOrAn() + " in " + wordWithAOrAn() + ".";
    }
...
function word() {
  return nouns[Math.ceil(Math.random() * nouns.length)];
}

function wordWithAOrAn() {
  var w = word();
  if(vowelTest(w[0])) {
    return "an " + w;
  } else {
